...
public boolean timeJudge(int time,int diff,char calc){
  if(calc == '+'){
...
public boolean button(String str,float buttonX,float buttonY,float wide,float high){
  strokeWeight(1);
  stroke(0);
  fill(255,200);
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "timer" });
  }
}
